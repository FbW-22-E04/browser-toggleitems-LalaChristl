...
h1.textContent = "My Favourite Destination";
...
li1.classList.add("list-group-item", "active");
...
button.addEventListener('click', () => {
    button.textContent = "Hide Destination";
...
ul.addEventListener('click', (e) => {
    if (e.target.tagName === 'LI') {
        ...
        p2.textContent = `You have selected ${e.target.textContent}`;
        ul.append(p2)
